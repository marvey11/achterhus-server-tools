...
| `storage-dir` | `Path` | `backup-drives` | Represents the directory containing the storage to be backed up. |
| `backup-dir` | `Path` | `backup-drives` | Represents the target directory for the backup. |
